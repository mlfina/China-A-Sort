...
cs_vw = read_pickle_file('../data/output/cs_vw.pkl')
cs_ew = read_pickle_file('../data/output/cs_ew.pkl')
...
uni_ret.T.to_csv('../data/output/sorted_portfolio_vw/unisort_returns.csv')
...
uni_ls_ret.to_csv('../data/output/sorted_portfolio_vw/unifactor_returns.csv')
...
bi_ret.T.to_csv('../data/output/sorted_portfolio_vw/bisort_returns.csv')
...
uni_ret.T.to_csv('../data/output/sorted_portfolio_ew/unisort_returns.csv')
...
uni_ls_ret.to_csv('../data/output/sorted_portfolio_ew/unifactor_returns.csv')
...
bi_ret.T.to_csv('../data/output/sorted_portfolio_ew/bisort_returns.csv')
